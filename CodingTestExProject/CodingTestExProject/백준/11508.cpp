...
KSG 편의점에서는 과일우유, 드링킹요구르트 등의 유제품을 '2+1 세일'하는 행사를 하고 있습니다. KSG 편의점에서 유제품 3개를 한 번에 산다면 그중에서 가장 싼 것은 무료로 지불하고 나머지 두 개의 제품 가격만 지불하면 됩니다. 
...
가장 비싼 것부터 정렬한뒤 순차적으로 정렬하고 3개씩 묶는다. 그중 가장 작은 3번째는
제외하여 합을 계산해주면 되는 문제이다.
*/
#include <iostream>
#include <algorithm>
using namespace std;
